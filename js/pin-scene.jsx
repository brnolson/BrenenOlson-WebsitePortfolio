...
const PinScene = ({ progress }) => {
  ...
  React.useEffect(() => {
    ...
    const DNA_HEIGHT = 4.2, TURNS = 3, DNA_RADIUS = 0.6, SEG = 90;
    const RUNG_COUNT = 18;
    ...
    const dnaAnchors = [
      { id: "BB", title: "Sugar-Phosphate", subtitle: "Backbone strand",
        pIn: 1.75, pOut: 2.45,
        localFn: () => { const [x,y,z] = strandPoint(25, 0, 0); return [x*1.5, y, z*1.5]; } },
      { id: "BP", title: "Base Pair",       subtitle: "A·T or G·C",
        pIn: 2.20, pOut: 2.90,
        localFn: () => { const [a,b] = rungEndpoints(9, 0); return [(a[0]+b[0])/2,(a[1]+b[1])/2,(a[2]+b[2])/2]; } },
      { id: "5",  title: "5′ End",         subtitle: "Phosphate terminus",
        pIn: 2.55, pOut: 3.20,
        localFn: () => [...strandPoint(SEG-1, 0, 0)] },
      { id: "MG", title: "Major Groove",   subtitle: "Wide face · 22 Å",
        pIn: 3.10, pOut: 3.65,
        localFn: () => [DNA_RADIUS * 1.6,  1.0, 0] },
      { id: "mg", title: "Minor Groove",   subtitle: "Narrow face · 12 Å",
        pIn: 3.40, pOut: 3.85,
        localFn: () => [-DNA_RADIUS * 1.6, -0.6, 0] },
      { id: "3",  title: "3′ End",         subtitle: "Hydroxyl terminus",
        pIn: 3.62, pOut: 4.00,
